...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-change-this-in-production-key-123456789')
...
# Database - Using SQLite for local, Firebase for attendance records
DATABASES = {
    'default': {
